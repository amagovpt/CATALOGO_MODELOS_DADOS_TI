...
é o `EnvironmentalManagementZone` inspirado no [FIWARE Smart Data Models](https://github.com/smart-data-models/).
...
| areaServed | String | A área geográfica que é gerida | Usar, sempre que possível, a área geográfica mais abrangente, para minimizar o número de entradas para situações onde existe gestão por associações de municípios. Modelo: [https://schema.org/Text](https://schema.org/Text)|
