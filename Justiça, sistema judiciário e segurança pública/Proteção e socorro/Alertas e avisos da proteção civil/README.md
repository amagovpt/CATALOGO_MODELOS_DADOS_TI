...
é o [Alert](https://github.com/smart-data-models/dataModel.Alert/tree/master/Alert) inspirado do [FIWARE Smart Data Models](https://github.com/smart-data-models/). 
