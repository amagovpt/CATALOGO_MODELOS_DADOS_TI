...
O modelo de dados para representar **Rede de Transporte Rodoviário** é o `RoadTransportNetwork` inspirado no [FIWARE Smart Data Models](https://github.com/smart-data-models/), baseado nos requisitos da diretiva [INSPIRE](https://inspire-geoportal.ec.europa.eu/srv/eng/catalog.search#/home) e nos conjuntos de dados de alto valor ([HVD](https://eur-lex.europa.eu/eli/reg_impl/2023/138/oj)).
