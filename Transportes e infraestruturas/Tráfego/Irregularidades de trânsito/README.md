...
O modelo de dados a seguir para representar **Irregularidades no trânsito** é o `Irregularities` como reportado pelo [Waze for Cities](https://www.waze.com/wazeforcities/). 
