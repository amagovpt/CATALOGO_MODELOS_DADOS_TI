...
O modelo de dados a seguir para representar **Gestão de ação social**
é o `SocialSupportObservation` inspirado no [FIWARE Smart Data Models](https://github.com/smart-data-models/).
