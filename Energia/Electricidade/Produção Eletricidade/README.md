...
| `aggregationLevel`  | String        | Nível de agregação física ou lógica representado pela entidade.  | Enumerado: <br>-device;<br>-unit;<br>-site<br>-building;<br>-campus;<br>-district;<br>-city;<br>-region;<br>-gridConnection;<br>-substation;<br>-marketUnit.<br> Modelo: [https://schema.org/Text](https://schema.org/Text). |
...
| `connectionType`    . | String        | Tipo de ligação elétrica à rede.                                 | Enumerado: <br>-offGrid; <br>-gridTied; <br>-hybrid <br>-islanded; <br>-microgridConnected; <br>-backupOnly.     <br> Modelo: [https://schema.org/Text](https://schema.org/Text).                     |
...
| `address`           | Object      | Endereço postal do local de instalação.                          | Modelo: [https://schema.org/address](https://schema.org/address)          |
...
| `status`            | String        | Estado operacional atual do gerador.                             | ExemEnumerado: <br>-operational, <br>-maintenance, <br>-fault, <br>-decommissioned.  |
